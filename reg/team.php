...
<button type="button" class="right" id="loadJR"><i class="fa fa-question-circle"></i> Help</button><ol class="joyride-list" data-joyride>
  ...
  <li data-id="phone" data-text="Next" data-prev-text="Prev"><h4>Save &ne; Submit</h4><p>You don't have to fill out every form in one time before save. You can edit your information and save it anytime until...</p></li>
