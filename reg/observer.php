...
<title>Observer registration :Chiang Mai University International Medical Challenge</title>
<!-- InstanceEndEditable -->
...
<div class="small-12 columns" id="content"><!-- InstanceBeginEditable name="Content" -->Observer registration<!-- InstanceEndEditable --></div>
</div><!--End Body-->
	<footer class="row">
		<div class="large-12 columns">
			<hr>
