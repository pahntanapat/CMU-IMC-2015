...
<div><label for="captcha">Answer = </label><input name="captcha" type="text" id="captcha" size="10" maxlength="8"  data-validation="number" placeholder="Answer"  required><script src="captcha.js"></script></div>